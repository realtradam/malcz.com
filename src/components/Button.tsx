...
type ButtonProps = {link: React.ReactElement, width?: number, height?: number, spinner?: number};
export default function Button ({ link , width = 36, height = 16, spinner = 4 }: ButtonProps) 
{
	return (
		<>
